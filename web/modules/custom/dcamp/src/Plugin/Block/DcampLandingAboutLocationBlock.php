 ...
 *
 * @Block(
 *   id = "dcamp_landing_about_location_block",
 *   admin_label = @Translation("DrupalCamp block for landing about the location")
 * )
 */
class DcampLandingAboutLocationBlock extends BlockBase implements BlockPluginInterface, ContainerFactoryPluginInterface{
